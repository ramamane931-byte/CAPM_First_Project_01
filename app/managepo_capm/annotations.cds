...
annotate service.PurchaseItemsSet with @(
    ...
    //Second Tab T2 = Item's, Object page / Third screen
    UI.Facets        : [{
        $Type : 'UI.ReferenceFacet',
        Label : 'Item Details',
        Target: '@UI.Identification',
...
//Below code has been auto generated by 'Sho Page Map' adding field property as Dropdown for 'Status' field
