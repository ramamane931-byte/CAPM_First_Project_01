...
using {ramdas.common as common} from './commons';
...
context transaction {
    entity purchaseorder : common.Amount, cuid { // added 'cuid' bcoz we have used standard guid aspect
        // key NODE_KEY         : common.Guid @(title: '{i18n>PO_KEY}'); ///Popup will appear while creating new instnce
    ...
    entity poitems : common.Amount, cuid { // added 'cuid' bcoz we have used standard guid aspect
        // key NODE_KEY     : common.Guid @(title: '{i18n>PO_ITEM_KEY}'); ///Popup will appear while creating new instnce
