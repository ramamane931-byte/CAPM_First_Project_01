...
//Here CAPM framework will automticlly convert CDSView name 'POWorkList' to 'POWORKLIST'.
//To make the CDS View name as per the requirement use special keyword '![<CDSViewName>]' to define the CDS View name.
//In this case we are defining the CDS View name as 'POWorkList' instead of 'POWORKLIST'.
context CDSViews {
    ...
    define view ProductView as
        select from master.product
        //Mixin is a keyword to define lose coupling (Assocition)
