...
module.exports = class CatalogService extends cds.ApplicationService {
  init() {
    ...
    this.after('READ', PurchaseOrderSet, async (purchaseOrderSet, req) => {
      ...
      //Below code to dispay Note for Product_Order_ID
    ...
    //While creating a new instance default value for the fields OVERALL_STATUS & LIFECYCLE_STATUS WILL 'N'.
    ...
    //implementation of action 'boost'- Create, Update data in server
    ...
    //implmentation of action - Create, Updata n server
    this.on('boost', async (req) => {

      //Debug      base on condition:
      // if(cond){
      //   debugger;
      // }

      // debugger;  //Hardcoded debugger
      try {
        //extact the primary key json - { NODE_KEY: 'Key Values' }
        const primarykey = req.params[0];
